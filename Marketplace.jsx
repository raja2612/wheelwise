...
import MarketCarCard from '../components/MarketCarCard';
import '../styles/Marketplace.css';

export default function Marketplace() {
  const navigate = useNavigate();
  const [marketCars] = useState([
    {
      id: 1,
      model: "Toyota Camry",
  ...
  const handlePurchaseClick = (car) => {
    // Ensure we're passing the complete car object
    navigate(`/purchase/${car.id}`, { 
      state: { 
        car: {
          ...car,
          // Add default values for required fields
          tokensOwned: car.tokensOwned || 0,
          availableDays: car.availableDays || 0,
          owners: car.owners || [],
  ...
  return (
    <div className="marketplace-page">
      <h1>Available Fractional Investments</h1>
